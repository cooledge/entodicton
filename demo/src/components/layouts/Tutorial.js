  ...
  render(){
    return (
      <div className='tutorial'>
        ...
        <h1 className='step1'>Step 1 - <a href={"https://github.com/cooledge/entodicton/blob/master/demo/src/bin/command_line_demo_1.js"}>Code</a></h1>
        <p>
        ...
        <h1 className='step2'>Step 2- <a href={"https://github.com/cooledge/entodicton/blob/master/demo/src/bin/command_line_demo_2.js"}>Code</a></h1>
        <p>
        ...
        <h1 className='step3'>Step 3- <a href={"https://github.com/cooledge/entodicton/blob/master/demo/src/bin/command_line_demo.js"}>Code</a></h1>
        <p>
