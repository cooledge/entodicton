...
module.exports = 
{
  ...
  "words": {
    "literals": {"+": [{"id": "plus", "uuid": "1"}], "a": [{"id": "aEnglish", "initial": {"language": "english"}, "uuid": "1"}], "buildings": [{"id": "buildingConcept", "uuid": "1"}], "cheeseburger": [{"id": "food", "initial": {"name": "cheeseburger"}, "uuid": "7"}], "cheeseburgers": [{"id": "food", "initial": {"name": "cheeseburger"}, "uuid": "7"}], "dollars": [{"id": "dollarConcept", "initial": {"language": "english"}, "uuid": "4"}], "et": [{"id": "conj", "initial": {"language": "english"}, "uuid": "1"}], "fries": [{"id": "food", "initial": {"name": "fries", "number": "many"}, "uuid": "7"}], "it": [{"id": "anyConcept", "initial": {"language": "english", "pullFromContext": true}, "uuid": "1"}], "joe": [{"id": "personConcept", "initial": {"id": "joe"}, "uuid": "4"}], "per": [{"id": "every", "uuid": "4"}], "plus": [{"id": "plus", "uuid": "1"}], "position": [{"id": "propertyConcept", "initial": {"name": "position"}, "uuid": "1"}], "sally": [{"id": "personConcept", "initial": {"id": "sally"}, "uuid": "4"}], "speed": [{"id": "propertyConcept", "initial": {"language": "english", "name": "velocity"}, "uuid": "1"}], "tanks": [{"id": "tankConcept", "initial": {"language": "english"}, "uuid": "1"}], "vitesse": [{"id": "propertyConcept", "initial": {"language": "french", "name": "velocity"}, "uuid": "1"}], "week": [{"id": "week", "initial": {"language": "english"}, "uuid": "4"}]},
    "patterns": [{"allow_partial_matches": false, "defs": [{"id": "number", "initial": "{ value: int(text) }", "uuid": "ONE"}, {"id": "count", "initial": "{ value: int(text) }", "uuid": "ONE"}], "pattern": [{"type": "digit"}, {"repeat": true}]}, {"allow_partial_matches": false, "defs": [{"id": "tankConcept", "initial": "{ id: text, language: 'english' }", "uuid": "ONE"}], "pattern": ["tank", {"type": "digit"}, {"repeat": true}]}, {"allow_partial_matches": false, "defs": [{"id": "tankConcept", "initial": "{ id: concat('tank', substr(text, 4)), language: 'french' }", "uuid": "ONE"}], "pattern": ["char", {"type": "digit"}, {"repeat": true}]}, {"allow_partial_matches": false, "defs": [{"id": "buildingConcept", "initial": "{ id: text, language: 'english' }", "uuid": "ONE"}], "pattern": ["building", {"type": "digit"}, {"repeat": true}]}, {"allow_partial_matches": false, "defs": [{"id": "buildingConcept", "initial": "{ id: concat('building', substr(text, 8)), language: 'french' }", "uuid": "ONE"}], "pattern": ["batiment", {"type": "digit"}, {"repeat": true}]}, {"allow_partial_matches": false, "defs": [{"remove": true}], "pattern": [{"type": "space"}, {"repeat": true}]}, {"allow_partial_matches": false, "defs": [{"id": "unknown", "initial": "{ value: text }", "uuid": "ONE"}], "pattern": [{"type": "alphanumeric"}, {"repeat": true}], "scale": 0.8}],
