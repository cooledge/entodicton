...
module.exports = 
{
  ...
  "bridges": [
    ...
    {"id": "query", "level": 0, "bridge": "{ marker: 'query', level: 1, isQuery: true }", "uuid": "1"},
    ...
    {"id": "plus", "level": 0, "selector": {"match": "same", "left": [{"marker": "number", "level": 1}], "right": [{"marker": "number", "level": 1}], "passthrough": true}, "bridge": "{ ...next(operator), value: add(before, after), marker: before[0].marker }", "uuid": "1"},
    {"id": "conj", "level": 0, "selector": {"match": "same", "left": [{"sentinals": [["number", 1]], "variable": "v", "no_match": [["nameableConcept", 1], ["anyConcept", 1]]}], "right": [{"sentinals": [["number", 1]], "variable": "v"}], "passthrough": true}, "bridge": "{ ...next(operator), value: append(before, after) }", "uuid": "1"},
    {"id": "conj", "level": 1, "selector": {"match": "same", "left": [{"sentinals": [["number", 1]], "variable": "v"}], "passthrough": true}, "bridge": "{ ...operator, value: append(before, operator.value) }", "uuid": "1"},
    ...
    {"id": "move", "level": 1, "bridge": "{ action: 'move', marker: 'move', level: 1, thing: operator.thing, place: operator.destination }", "uuid": "1"},
    ...
    {"id": "create", "level": 1, "bridge": "{ action: 'create', marker: 'create', level: 1, klass: operator.klass }", "uuid": "1"},
    ...
    {"id": "deplacez", "level": 1, "bridge": "{ action: 'move', marker: 'move', level: 1, thing: operator.thing, place: operator.vers }", "uuid": "1"},
    {"id": "bougez", "level": 0, "bridge": "{ place: after[0].destination, thing: after[0].thing, ...next(operator) }", "uuid": "1"},
    {"id": "bougez", "level": 1, "bridge": "{ action: 'move', marker: 'move', level: 1, thing: operator.thing, place: operator.place }", "uuid": "1"},
  ...
  "hierarchy": [
    [["tankConcept", 1], ["nameableConcept", 1]],
    [["buildingConcept", 1], ["nameableConcept", 1]],
    [["tankConcept", 1], ["anyConcept", 1]],
    [["buildingConcept", 1], ["anyConcept", 1]],
  ],
  "priorities": [
