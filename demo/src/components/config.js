...
module.exports = 
{
  ...
  "words": {
    ...
    "patterns": [{"defs": [{"id": "number", "initial": "{ value: int(text) }", "uuid": "1"}, {"id": "count", "initial": "{ value: int(text) }", "uuid": "1"}], "pattern": [{"type": "digit"}, {"repeat": true}]}, {"defs": [{"id": "tankConcept", "initial": "{ id: text, language: 'english' }", "uuid": "1"}], "pattern": ["tank", {"type": "digit"}, {"repeat": true}]}, {"defs": [{"id": "tankConcept", "initial": "{ id: concat('tank', substr(text, 4)), language: 'french' }", "uuid": "1"}], "pattern": ["char", {"type": "digit"}, {"repeat": true}]}, {"defs": [{"id": "buildingConcept", "initial": "{ id: text, language: 'english' }", "uuid": "1"}], "pattern": ["building", {"type": "digit"}, {"repeat": true}]}, {"defs": [{"id": "buildingConcept", "initial": "{ id: concat('building', substr(text, 8)), language: 'french' }", "uuid": "1"}], "pattern": ["batiment", {"type": "digit"}, {"repeat": true}]}],
    "hierarchy": [],
  },
  "floaters": [
    "language",
