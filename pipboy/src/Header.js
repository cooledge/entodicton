...
function Header({ activeTab, setActiveTab }) {
  ...
  return (
    <div className="Header">
      ...
      <a style={ {'color': 'white', 'margin-left': '20px'} } href={'https://github.com/thinktelligence/theprogrammablemind/blob/8.9.0/kms/common/pipboy.js'} target="_blank" rel="noreferrer">Source Code of Language Config</a>
      <a style={ {'color': 'white', 'margin-left': '20px'} } href={'https://github.com/cooledge/entodicton/blob/master/website_test/tests/pipboy.test.js'} target="_blank" rel="noreferrer">Integration Tests</a>
