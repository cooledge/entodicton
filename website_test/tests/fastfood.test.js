...
describe('tests for fastfood page', () => {
  ...
  test(`FASTFOOD select unselect weapons`, async () => {
  ...
  test(`FASTFOOD select unselect apparel`, async () => {
  ...
  test(`FASTFOOD outfits - wear`, async () => {
  ...
  test(`FASTFOOD outfits - put on`, async () => {
  ...
  const testUseList = async (query, allItems, type, message, checkList, getsUsedUp) => {
    return test(`FASTFOOD ${query}`, async () => {
